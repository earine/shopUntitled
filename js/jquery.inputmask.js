        ...
        n = [a(4), a(6)], void 0 === (r = "function" == typeof (i = function (L, M, V) {
            ...
            function maskScope(e, t, F) {
                ...
                function getTests(D, e, t) {
                    var B, a = getMaskSet().maskToken, O = e ? t : 0, i = e ? e.slice() : [0], I = [], j = !1,
                        N = e ? e.join("") : "";
                        ...
                        function handleMatch(e, t, a) {
                            ...
                            if (e.matches !== V) {
                                if (e.isGroup && a !== e) {
                                    ...
                                    var n, r = e, o = [], s = I.slice(), l = t.length,
                ...
                function alternate(e, t, a, i, n) {
                    var r, o, s, l, u, c, p, f = L.extend(!0, {}, getMaskSet().validPositions), m = !1,
                ...
                var a, s = {
                    ...
                    inputFallBackEvent: function inputFallBackEvent(e) {
                        ...
                        if (getBuffer().join("") !== t) {
                            ...
                            if (t = function ieMobileHandler(e, t, a) {
                                ...
                                var n = getBuffer().join(""), r = !F.numericInput && t.length > n.length ? -1 : 0,
                                    o = t.substr(0, a.begin), s = t.substr(a.begin), l = n.substr(0, a.begin + r),
                                    u = n.substr(a.begin + r), c = a, p = "", f = !1;
                                if (o !== l) {
                    ...
                    cutEvent: function cutEvent(e) {
                        L(this);
                        var t = caret(this), a = e.originalEvent || e, i = M.clipboardData || a.clipboardData,
                ...
                function determineLastRequiredPosition(e) {
                    var t, a, i = getMaskTemplate(!0, getLastValidPosition(), !0, !0), n = i.length,
            ...
            function analyseMask(e, t, r) {
                ...
                function setValue(e, t, a) {
                    e[o] = function extendProperty(e) {
                        ...
                        if (t != e) {
                            var a = e.replace(/[^0-9]/g, ""), i = (r.min && r.min[o] || e).toString(),
            ...
            return k.extendAliases({
                numeric: {
                    ...
                    onBeforeMask: function onBeforeMask(e, t) {
                        ...
                        var i = e.split(a), n = i[0].replace(/[^\-0-9]/g, ""),
